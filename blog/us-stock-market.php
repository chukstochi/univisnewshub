...
<section class="search__bar">
     <form class="search__bar-container" action="<?= ROOT_URL ?>search.php" method="GET">
          <div>
...
<section class="post">
     <div class="container">
          <h2 class="section__title">US STOCK MARKET</h2>

          <div class="post__grid" style="display: grid; grid-template-columns: repeat(auto-fill, minmax(250px, 1fr)); gap: 2rem;">
               <?php
               // Get US NEWS category ID
               $category_query = "SELECT id FROM categories WHERE title='US NEWS' LIMIT 1";
               $category_result = mysqli_query($connection, $category_query);
               $us_category = mysqli_fetch_assoc($category_result);
               ...
               ?>
                         <article class="post__card" style="border-radius: 10px; box-shadow: 0 0 10px rgba(0,0,0,0.1); overflow: hidden;">
                              ...
                              <div class="post__info" style="padding: 1rem;">
                                   <a href="us-stock-market.php" class="category__button">US STOCK MARKET</a>
